...
public class InfoPanelView : MonoBehaviour
{
    ...
    private readonly string _correctStr = "Buenaaa   +" + GameManager.CorrectAddTime + "seg.";
    private readonly string _missStr = "No está mal...   " + GameManager.MissAddTime + "seg.";


    private readonly string _quickCorrectStr = "¡Excelente!   +" + GameManager.QuickCorrectAddTime + "seg.";
